...
{
	if (!TheTextureManager::Instance()->load("assets/Instruc_Move.png", "Instruc1", TheGame::Instance()->getRenderer())) {
		std::cout << "Error: " << SDL_GetError();
	}
	if (!TheTextureManager::Instance()->load("assets/Instruc_Jump.png", "Instruc2", TheGame::Instance()->getRenderer())) {
		std::cout << "Error: " << SDL_GetError();
	}
	if (!TheTextureManager::Instance()->load("assets/Instruc_Hold.png", "Instruc3", TheGame::Instance()->getRenderer())) {
		std::cout << "Error: " << SDL_GetError();
	}
	if (!TheTextureManager::Instance()->load("assets/Instruc_Double.png", "Instruc4", TheGame::Instance()->getRenderer())) {
		std::cout << "Error: " << SDL_GetError();
	}
	if (!TheTextureManager::Instance()->load("assets/Instruc_Dash.png", "Instruc5", TheGame::Instance()->getRenderer())) {
		std::cout << "Error: " << SDL_GetError();
	}
	if (!TheTextureManager::Instance()->load("assets/Instruc_Aim.png", "Instruc6", TheGame::Instance()->getRenderer())) {
		std::cout << "Error: " << SDL_GetError();
	}
	if (!TheTextureManager::Instance()->load("assets/Instruc_Fire.png", "Instruc7", TheGame::Instance()->getRenderer())) {
		std::cout << "Error: " << SDL_GetError();
	}
...
void Level_One::createObjects(std::vector<SDLGameObject* >* gameObjects, std::vector<SDLGameObject*>* platforms, std::vector<SDLGameObject*>* hazards)
{
	...
	// Double Jump
	SDLGameObject* box1 = new Platform(new LoaderParams(3940, 740, 160, 160, "bluebox"));
	SDLGameObject* box2 = new Platform(new LoaderParams(3940, 580, 160, 160, "bluebox"));
	SDLGameObject* box3 = new Platform(new LoaderParams(3700, 420, 160, 160, "greenbox"));
	SDLGameObject* box4 = new Platform(new LoaderParams(3700, 260, 160, 160, "greenbox"));
	SDLGameObject* box5 = new Platform(new LoaderParams(4100, 420, 160, 160, "bluebox"));
	SDLGameObject* box6 = new Platform(new LoaderParams(4100, 260, 160, 160, "bluebox"));
	SDLGameObject* box7 = new Platform(new LoaderParams(4100, 100, 160, 160, "bluebox"));
	SDLGameObject* box8 = new Platform(new LoaderParams(4100, -60, 160, 160, "bluebox"));
	SDLGameObject* box9 = new Platform(new LoaderParams(4100, 740, 160, 160, "bluebox"));
	SDLGameObject* box10 = new Platform(new LoaderParams(4100, 580, 160, 160, "bluebox"));
	// Dash
	SDLGameObject* box11 = new Platform(new LoaderParams(4100, -620, 160, 160, "greenbox"));
	SDLGameObject* box12 = new Platform(new LoaderParams(4260, -620, 160, 160, "greenbox"));
	SDLGameObject* box13 = new Platform(new LoaderParams(4420, -620, 160, 160, "greenbox"));
	SDLGameObject* box14 = new Platform(new LoaderParams(4580, -620, 160, 160, "greenbox"));
	SDLGameObject* box15 = new Platform(new LoaderParams(4740, -620, 160, 160, "greenbox"));
	SDLGameObject* box16 = new Platform(new LoaderParams(4900, -620, 160, 160, "greenbox"));
	SDLGameObject* box17 = new Platform(new LoaderParams(4100, -780, 160, 160, "greenbox"));
	SDLGameObject* plat20 = new Platform(new LoaderParams(6000, -220, 100, 40, "platform"));
	SDLGameObject* plat21 = new Platform(new LoaderParams(6100, -220, 100, 40, "platform"));
	// Hook
	SDLGameObject* plat22 = new Platform(new LoaderParams(6000, -1000, 100, 40, "platform"));
	SDLGameObject* plat23 = new Platform(new LoaderParams(6100, -1000, 100, 40, "platform"));
	SDLGameObject* box18 = new Platform(new LoaderParams(6000, -1800, 160, 160, "bluebox"));
	SDLGameObject* box19 = new Platform(new LoaderParams(6320, -1640, 160, 160, "bluebox"));
	// Finish
	SDLGameObject* winPlat = new Platform(new LoaderParams(5500, -1800, 100, 40, "finish"));

	SDLGameObject* intruct1 = new Platform(new LoaderParams(500, 700, 200, 150, "Instruc1"));
	SDLGameObject* intruct2 = new Platform(new LoaderParams(1500, 700, 200, 150, "Instruc2"));
	SDLGameObject* intruct3 = new Platform(new LoaderParams(2400, 700, 200, 150, "Instruc3"));
	SDLGameObject* intruct4 = new Platform(new LoaderParams(3700, 700, 200, 150, "Instruc4"));
	SDLGameObject* intruct5 = new Platform(new LoaderParams(4000, -250, 200, 150, "Instruc5"));
	SDLGameObject* intruct6 = new Platform(new LoaderParams(5900, -1200, 200, 150, "Instruc6"));
	SDLGameObject* intruct7 = new Platform(new LoaderParams(6200, -1200, 200, 150, "Instruc7"));

	//Hazards
	
	SDLGameObject* haz1 = new Hazard(new LoaderParams(3100, 700, 100, 100, "hazard"));
	SDLGameObject* haz2 = new Hazard(new LoaderParams(4143, -900, 74, 85, "hazard2"));
	SDLGameObject* haz3 = new Hazard(new LoaderParams(6050, -1580, 60, 60, "hazard3"));
